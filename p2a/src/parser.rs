...
impl ProstAttribute {
    pub fn parse_with_namespace(
        ...
        let mut attr = ProstAttribute::default();
        ...
        loop {
            ...
            match ident.to_string().as_str() {
                ...
                "int32" => {
                    ...
                    attr.cardinality = Cardinality::Singular;
                }
                "int64" => {
...
//                     input.parse::<syn::Token![=]>()?;
//                     let path: syn::LitStr = input.parse()?;
//                     attr.r#type = Type::Enum(path.parse()?);
//                 }
//                 "map" => {
//                     input.parse::<syn::Token![=]>()?;
//                     let map_types: syn::LitStr = input.parse()?;
...
//                     let key_type = parse_type_from_str(parts[0])?;
//                     let value_type = parse_type_from_str(parts[1])?;
...
//                     input.parse::<syn::Token![=]>()?;
//                     let path = input.parse::<syn::LitStr>()?;
//                     attr.r#type = Type::Oneof(path.parse()?);
//                     attr.cardinality = Cardinality::Optional;
//                 }
//                 "bytes" => {
//                     attr.r#type = Type::Bytes;
